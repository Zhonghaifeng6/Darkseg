...
from models.model import DarkSeg
...
def get_args():
    ...
    parser.add_argument('--model', '-m', default='./data/checkpoints/epoch_20.pth',
                        metavar='FILE',
                        help="Specify the file in which the model is stored")
    parser.add_argument('--input', '-i', type=str, default='./data/test/input',
                        help='Directory of input images')
    parser.add_argument('--output', '-o', type=str, default='./data/test/output',
