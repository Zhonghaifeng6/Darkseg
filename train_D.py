    ...
    for epoch in range(cfg.epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{cfg.epochs}', unit='img') as pbar:
            for batch in train_loader:
                ...
                infr_masks,mid_21,mid_22,mid_23,mid_24= net1(batch_imgs)
                ...
                if cfg.deepsupervision:
                    ...
                    loss_init = criterion(inferences, masks)
                    loss_infr = criterion(infr_masks, masks)

                loss_total = loss_init + loss_infr + loss_s1*0.25  + loss_s2*0.25 + loss_s3*0.25 + loss_s4*0.25
